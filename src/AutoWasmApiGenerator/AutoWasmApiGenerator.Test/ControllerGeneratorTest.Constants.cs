...
";
    ...
    #region Virtual
     ...
     private const string TestVirtualSource = @"namespace AutoWasmApiGenerator.Test;

[WebController(Partial = true)]
public interface ITest
{
    [WebMethod(Virtual = true)]
    void Log(string message);
}
";

    private static string TestVirtualSourceResult;

    private static void UpdateVirtualResult()
    {
        TestVirtualSourceResult
            = $$"""
                // <auto-generated/>
                #pragma warning disable
                #nullable enable
                ...
                namespace AutoWasmApiGenerator.Test
                {
                    ...
                    public partial class TestController : global::Microsoft.AspNetCore.Mvc.ControllerBase
                    {
                        ...
                        [global::Microsoft.AspNetCore.Mvc.HttpPost("Log")]
                        [global::System.CodeDom.Compiler.GeneratedCode("AutoWasmApiGenerator.ControllerGenerator", "{{GeneratorVersion}}")]
                        public virtual void Log([global::Microsoft.AspNetCore.Mvc.FromBody]string message)
                          => proxyService.Log(message);
                    }
                }
                """;
